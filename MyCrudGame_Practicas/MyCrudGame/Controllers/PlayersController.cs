...
namespace MyCrudGame.Controllers
{
    public class PlayersController : Controller
    {
        ...
        public PlayersController(CRUDMyGameContext context)
        {
            _context = context;
        }
        ...
        {
            var cRUDMyGameContext = _context.Players.Include(p => p.IdNavigation);
        ...
        public async Task<IActionResult> Create([Bind("Id,NickName")] Player player)
        {
            ...
            ViewData["Id"] = new SelectList(_context.Users, "Id", "FirstName", player.Id);
            return View(player);
        }
